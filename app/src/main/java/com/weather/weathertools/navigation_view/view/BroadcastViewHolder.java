...
public class BroadcastViewHolder extends RecyclerView.ViewHolder {
    ...
    public BroadcastViewHolder(@NonNull View itemView, Context context) {
        ...
        recyclerView = itemView.findViewById(R.id.broadcast_recycler_view);
        recyclerView.setLayoutManager(new LinearLayoutManager(context));
        recyclerView.addItemDecoration(new DividerItemDecoration(context,DividerItemDecoration.VERTICAL));
        tvTitle = itemView.findViewById(R.id.broadcast_title);
        ivIcon = itemView.findViewById(R.id.broadcast_icon);
    }

    public void setData(ArrayList<String> broadcatArray) {
        final BroadCastAdapter adapter = new BroadCastAdapter(broadcatArray,context);
